...
## Table of Contents
  ...
  - [Pre-requisites] (#pre-requisites)
    - [Write permissions enabled] (#write-activated)
    - [Install Git] (#install-git)
      - [1) Install Git:] (#install-git)
      - [2) Accept installation of Git:] (#accept-installation-git)
      - [3) Wait until the installation finishes:] (#wait-git)
  - [Installation] (#installation)
    - [1) Get TermuxTex] (#get-termuxtex)
    - [2) Open the termuxtex folder] (#abrir-termuxtex)
    - [3) Run the termuxtex.sh script] (#execute-script-termuxtex)
  - [Example] (#example)
